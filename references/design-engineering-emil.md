...
> **Cached verbatim** from `github.com/emilkowalski/skill` → `skills/emil-design-eng/SKILL.md`
> Cached locally 2026-05-15 to protect against link rot.
> Source page: [emilkowal.ski/skill](https://emilkowal.ski/skill) · Course: [animations.dev](https://animations.dev/)
>
> **Original frontmatter** (preserved for reference):
